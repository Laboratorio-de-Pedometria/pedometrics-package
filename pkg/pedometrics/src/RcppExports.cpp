...
RcppExport SEXP pedometrics_calcMSSDCpp(SEXP xSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
...
RcppExport SEXP pedometrics_updateMSSDCpp(SEXP x1SEXP, SEXP x2SEXP, SEXP dmSEXP, SEXP idxSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
...
RcppExport SEXP pedometrics_updatePPLCpp(SEXP xSEXP, SEXP dmSEXP, SEXP idxSEXP) {
BEGIN_RCPP
    SEXP __sexp_result;
    {
        Rcpp::RNGScope __rngScope;
